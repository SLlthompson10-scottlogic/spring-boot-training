...
//
    ...
    void OrderBuyLists() {
        ...
        Assertions.assertTrue(matcher.buyList.get(0).account.equals("account1"));
        Assertions.assertTrue(matcher.buyList.get(1).account.equals("account3"));
        Assertions.assertTrue(matcher.buyList.get(2).account.equals("account4"));
        Assertions.assertTrue(matcher.buyList.get(3).account.equals("account5"));
        Assertions.assertTrue(matcher.buyList.get(4).account.equals("account2"));
        Assertions.assertTrue(matcher.buyList.get(5).account.equals("account6"));
    }
    ...
    void OrderSellLists() {
        ...
        Assertions.assertTrue(matcher.sellList.get(0).account.equals("account9"));
        Assertions.assertTrue(matcher.sellList.get(1).account.equals("account7"));
        Assertions.assertTrue(matcher.sellList.get(2).account.equals("account10"));
        Assertions.assertTrue(matcher.sellList.get(3).account.equals("account11"));
        Assertions.assertTrue(matcher.sellList.get(4).account.equals("account8"));
    }
    ...
    void updateBuyList() {
        ...
        Assertions.assertTrue(matcher.buyList.get(0).account.equals("account4"));
        Assertions.assertTrue(matcher.buyList.get(1).account.equals("account5"));
        Assertions.assertTrue(matcher.buyList.get(2).account.equals("account2"));
        Assertions.assertTrue(matcher.buyList.get(3).account.equals("account6"));
        Assertions.assertTrue(matcher.sellList.get(0).account.equals("account8"));
    ...
    void updateAgSellList() {
        ...
        Assertions.assertTrue(matcher.buyList.get(0).account.equals("account6"));
        Assertions.assertTrue(matcher.buyList.get(0).quantity==11);

        Assertions.assertTrue(matcher.sellList.get(0).account.equals("account10"));
        Assertions.assertTrue(matcher.sellList.get(0).quantity==10);
        Assertions.assertTrue(matcher.sellList.get(1).account.equals("account11"));
        Assertions.assertTrue(matcher.sellList.get(1).quantity==20);
        Assertions.assertTrue(matcher.sellList.get(2).account.equals("account8"));
        Assertions.assertTrue(matcher.sellList.get(2).quantity==5);
